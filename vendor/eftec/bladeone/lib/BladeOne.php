...
class BladeOne
{
    ...
    protected $echoFormat = '\htmlentities(%s, ENT_QUOTES|ENT_SUBSTITUTE)';
    /** @var string */
    ...
    public function showError($id, $text, $critic = false, $alwaysThrow = false): string
    {
        ...
        $msg .= "CanThink Framework Error [$id]:<br>";
    ...
    public function getTemplateFile($templateName = ''): string
    {
        ...
        $path = \implode('/', $arr);
        $path = '../../../'.$path; // add by Fahmy (28/07/2022)
     ...
     * @return string
     */
    public function getCsrfToken($fullToken = false, $tokenId = '_canthinkframework2022'): string
    {
        if ($this->csrf_token == '') {
